...
const founders = [
  {
    ...
    initials: "MP",
    bio: "Olen 18-vuotias Otaniemen lukion toisen vuoden opiskelija. Yrittäjyys tuntui minulle jo varhain oikealta suunnalta — haluan rakentaa jotain oikeaa enkä odottaa siihen lupaa. Pelaan tennistä kilpatasolla, käyn salilla säännöllisesti ja uskon siihen että kaikessa mitä tehdään, tehdään kunnolla. Puuhapatet on meille molemmille askel kohti isompia projekteja.",
  ...
  },
  {
    ...
    age: 17,
    role: "Perustaja",
    photo: "/team/joonatan.jpg",
    initials: "JJ",
    bio: "Olen 17-vuotias ja opiskelen myös Otaniemen lukiossa toista vuotta. Taustani on kansainvälinen — olen opiskellut ja asunut ulkomailla, mikä on antanut laajan näkemyksen asioihin jo nuorella iällä. Tennis, sali ja kilpaurheilu kuuluvat arkeeni. Yrittäjyys on minulle tapa yhdistää intohimo, oppiminen ja oikea tekeminen.",
