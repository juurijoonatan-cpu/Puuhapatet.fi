 ...
 *
 * The public chat is stateless and lives in the visitor's browser; casual
 * chats are never stored. This inbox lists only the explicit contact requests
 * (handoffs) visitors leave — a lightweight lead/stat the team follows up by
 * phone or email. We are not live in the chat, so there is no live reply here.
 */
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Verkkochatista jätetyt yhteydenotot — soita tai laita viestiä</p>
            </div>
          </div>
