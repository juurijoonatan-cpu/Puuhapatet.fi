...
const translations: Record<Language, Record<string, string>> = {
    ...
    "hero.subtitle": "Kaksi reipasta nuorta yrittäjää Espoosta — täydellä sydämellä töissä. Ikkunanpesu, pihatyöt ja käytännön kotitalouspalvelut oikeasti hyvin tehtyinä positiivisella ja intohimoisella asenteella! Ole rohkeasti yhteydessä!",
  ...
  en: {
    ...
    "hero.subtitle": "Two young entrepreneurs from Espoo — putting real effort in. Window cleaning, yard work and home services done properly. Streak-free finish, price agreed before we start.",
    ...
    "about.matias.bio": "I'm 18 and in my second year at Otaniemi High School. Football has taken me far — I've competed at a high level for years and the gym is part of daily life. My sports background has taught me what entrepreneurship also demands: commitment, discipline and a drive to improve. Puuhapatet is my first real step into entrepreneurship — and I intend to take it seriously.",
    "about.joonatan.bio": "I'm 18 and a student at Otaniemi High School. Sport has always been close to my heart — competitive running, the gym and tennis are part of everyday life. My sports background has taught me what entrepreneurship also demands: commitment, discipline and a drive to improve. I've grown up in four different countries and travelled extensively around the world — that has taught me to embrace new situations and look at things from a fresh angle. Entrepreneurship has been on my mind for a long time and I've had several projects along the way. Puuhapatet is the one where all the pieces fall into place. By nature I'm energetic, direct and driven. I aim to keep the quality of my work as high as possible, job after job. I hope to have the pleasure of serving you!",
    "about.petrus.bio": "I'm 16 and a student at Porkkala Upper Secondary School, with a keen interest in entrepreneurship, self-improvement and an active lifestyle. I do a wide range of sports, especially gym training, downhill skiing and hiking.\n\nSport has taught me to set goals and to work with discipline and persistence — qualities I bring to my work as well. I'm energetic, self-driven and reliable, and I handle every job carefully and with the customer in mind.\n\nI also have previous experience in window cleaning, so the work is already familiar to me. I hope I get the chance to help you!",
