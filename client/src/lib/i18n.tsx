...
const translations: Record<Language, Record<string, string>> = {
    ...
    "service.senior.title": "SenioriSelko™",
    "service.senior.desc": "Puhelin, joka toimii. Aina. Käyttäjän iästä huolimatta.",
    "service.senior.coming": "Tulossa!",
    
    "service.special.title": "Erikoistyöt",
    "service.special.desc": "Liikehuoneistojen lasit sopimuksen mukaan",
  ...
  en: {
    ...
    "service.senior.title": "SenioriSelko™",
    "service.senior.desc": "A phone that works. Always. Regardless of user's age.",
    "service.senior.coming": "Coming soon!",
    
    "service.special.title": "Special Services",
    "service.special.desc": "Commercial premises glass by agreement",
