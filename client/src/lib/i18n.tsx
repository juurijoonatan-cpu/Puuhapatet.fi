...
const translations: Record<Language, Record<string, string>> = {
    ...
    "hero.pill": "Ammattitaitoinen ikkunanpesu",
    ...
    "services.promise": "Jokainen työmme tehdään vastuuvakuutuksen alaisena ja lainmukaisesti. Meille tärkeintä on se, että asiakkaamme on tyytyväinen — ei se, kuinka nopeasti saamme työn alta pois. Jos homma ottaa kauemmin kuin arvioitu, teemme sen silti kunnolla loppuun. Siitä ei tule lisälaskua.",
    ...
    "faq.a3": "Hinta sovitaan etukäteen kohteen koon ja ikkunoiden määrän perusteella. Ei yllätyksiä — tiedät hinnan ennen kuin aloitamme.",
    ...
    "faq.a7": "Pyrimme vastaamaan saman päivän aikana, viimeistään seuraavana arkipäivänä.",
    ...
    "about.desc": "Espoolainen pienyrittäjä. Tehdään homma hyvin.",
    "about.story.1": "Puuhapatet on espoolainen palveluyritys. Teemme ikkunanpesua, pihatöitä ja muita käytännön kotitalouspalveluja.",
    "about.story.2": "Lupaamme yksinkertaisen asian: työ tehdään kunnolla, sovittuun aikaan ja siististi. Ei yllätys-laskuja, ei epäselvyyksiä.",
  ...
  en: {
    ...
    "hero.subtitle": "We clean windows inside and out, balcony glass and glass terraces — with the right tools and products that actually work. Streak-free finish, clear price.",
    ...
    "services.promise": "Every job we do is covered by liability insurance and fully compliant with Finnish law. What matters most to us is that the customer is happy — not how quickly we can move on. If a job takes longer than expected, we finish it properly regardless. No extra charge.",
    ...
    "faq.a7": "We aim to respond the same day, latest the next working day.",
    ...
    "about.desc": "A small Espoo-based service company. We do the job right.",
    "about.story.1": "Puuhapatet is an Espoo-based small business. We do window cleaning, yard work and other practical household services.",
    "about.story.2": "Our promise is simple: the work gets done properly, on time and cleanly. No surprise invoices, no confusion.",
