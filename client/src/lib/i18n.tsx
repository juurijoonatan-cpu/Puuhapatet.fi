...
const translations: Record<Language, Record<string, string>> = {
    ...
    "ba.body": "Vasemmalla lasi ennen pesua, oikealla saman aamun jälki. Ei uutta kuvakulmaa, ei suodattimia — vedä jakoviivaa ja katso itse.",
    "ba.before": "Ennen",
    "ba.after": "Jälkeen",
    ...
    "ba.point.2": "Kotitalousvähennys −35 % työn osuudesta",
    "ba.point.3": "Ilmainen kartoitus ennen kuin sovitaan mitään",
    "ba.cta": "Pyydä oma ennen–jälkeen",
  ...
  en: {
    ...
    "ba.body": "On the left, the glass before the wash; on the right, the same morning after. No new angle, no filters — drag the divider and judge it yourself.",
    "ba.before": "Before",
    "ba.after": "After",
    ...
    "ba.point.2": "Household tax deduction −35 % of the labour",
    "ba.point.3": "A free assessment before anything is agreed",
    "ba.cta": "Get your own before & after",
