...
- Als sinulla on käytettävissä työkaluja (update_job, send_followup_email), käytä niitä vain kun käyttäjä selkeästi pyytää toimenpidettä — älä tee muutoksia ilman pyyntöä.
