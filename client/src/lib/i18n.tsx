...
const translations: Record<Language, Record<string, string>> = {
    ...
    "hero.subtitle": "Kaksi nuorta yrittäjää Espoon Otaniemestä — täydellä sydämellä töissä. Ikkunanpesu, pihatyöt ja käytännön kotitalouspalvelut oikeasti hyvin tehtyinä. Raitatonjälki, hinta sovitaan etukäteen.",
    ...
    "faq.a1": "Pääasiassa Espoon länsiosissa: Westend, Haukilahti, Saunalahti ja Suvisaaristo. Palvelemme myös Helsingin länsirannalla: Munkkiniemi, Munkkivuori, Lauttasaari ja Kuusisaari. Muille alueille sovitaan erikseen — kysy vain.",
    "faq.q2": "Mitä ikkunanpesuun kuuluu?",
    "faq.a2": "Pesemme ikkunat sisältä ja ulkoa sovitun mukaan, parvekelasit ja lasiterassit mukaan lukien. Tavoitteena on aina siisti, raitatonjälki.",
    ...
    "about.story.3": "Toimimme pääasiassa Espoon länsiosissa ja Helsingin länsirannalla. Kysy myös muista alueista.",
  ...
  en: {
    ...
    "faq.a1": "Mainly western Espoo: Westend, Haukilahti, Saunalahti and Suvisaaristo. We also cover Helsinki's western waterfront: Munkkiniemi, Munkkivuori, Lauttasaari and Kuusisaari. Other areas by arrangement — just ask.",
    ...
    "about.story.3": "We work mainly in western Espoo and along Helsinki's western waterfront. Ask about other areas too.",
    ...
    "about.area.espoo": "Espoo: Westend, Haukilahti, Saunalahti, Suvisaaristo",
    "about.area.helsinki": "Helsinki: Munkkiniemi, Munkkivuori, Lauttasaari, Kuusisaari",
    "about.area.other": "Other areas by arrangement — just ask.",
