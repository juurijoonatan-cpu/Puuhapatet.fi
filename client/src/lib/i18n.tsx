...
const translations: Record<Language, Record<string, string>> = {
    ...
    "hero.subtitle": "Sisä- ja ulkopinnat, parvekelasit ja lasiterassit — ammattivälineillä ja toimivaksi todetuilla tuotteilla. Siisti, raitatonta lopputulosta. Selkeä hinnoittelu.",
    ...
    "service.basic.desc": "Ammattivälineillä ja toimivaksi todetuilla pesuaineilla. Työmme tulos on kirkas, raitatonpinta — ikkunat, parvekelasit ja lasiterassit.",
    ...
    "reviews.leave.title": "Jätä arvostelu",
    "reviews.leave.step1": "Suosittelisitko meitä kaverillesi?",
    "reviews.leave.step2": "Mikä palvelu?",
    "reviews.leave.step3": "Haluatko sanoa jotain lisää?",
    "reviews.leave.step4": "Nimesi ja asuinalueesi",
    "reviews.leave.optional": "(vapaaehtoinen)",
    "reviews.leave.placeholder": "Kerro kokemuksestasi...",
    "reviews.leave.name": "Koko nimi",
    "reviews.leave.area": "Asuinalue",
    "reviews.leave.next": "Seuraava",
    "reviews.leave.submit": "Lähetä arvostelu",
    "reviews.leave.thanks": "Kiitos arvostelusta!",
    "reviews.leave.service.windows": "Ikkunanpesu",
    "reviews.leave.service.balcony": "Parvekelasit",
    "reviews.leave.service.talvikiilto": "Talvikiilto",
    "reviews.leave.service.other": "Muu palvelu",
    "reviews.sample.1.text": "Ammattitaitoista työtä ja selkeä lopputulos. Ikkunat loistavat!",
    "reviews.sample.1.name": "Maria K.",
    "reviews.sample.1.location": "Westend",
    "reviews.sample.2.text": "Nopea ja luotettava palvelu. Talvikiilto-huolto oli erinomainen.",
    "reviews.sample.2.name": "Jukka L.",
    "reviews.sample.2.location": "Haukilahti",
    "reviews.sample.3.text": "Selkeä hinnoittelu ja sovittu aika piti. Suosittelen!",
    "reviews.sample.3.name": "Anna S.",
    "reviews.sample.3.location": "Saunalahti",
  },
  en: {
    "nav.home": "Home",
    ...
    "hero.subtitle": "Interior and exterior, balcony glass and glass terraces — with professional equipment and proven products. Streak-free results. Clear pricing.",
    ...
    "reviews.leave.step1": "Would you recommend us to a friend?",
    "reviews.leave.step2": "Which service?",
    "reviews.leave.step3": "Anything else to add?",
    "reviews.leave.step4": "Your name and area",
    "reviews.leave.optional": "(optional)",
    "reviews.leave.placeholder": "Tell us about your experience...",
    "reviews.leave.name": "Full name",
    "reviews.leave.area": "Area",
    "reviews.leave.next": "Next",
    "reviews.leave.submit": "Submit Review",
    "reviews.leave.thanks": "Thank you for your review!",
    "reviews.leave.service.windows": "Window cleaning",
    "reviews.leave.service.balcony": "Balcony glass",
    "reviews.leave.service.talvikiilto": "Talvikiilto",
    "reviews.leave.service.other": "Other service",
    "reviews.sample.1.text": "Professional work and clear results. Windows are sparkling!",
    "reviews.sample.1.name": "Maria K.",
    "reviews.sample.1.location": "Westend",
    "reviews.sample.2.text": "Fast and reliable service. Talvikiilto care was excellent.",
    "reviews.sample.2.name": "Jukka L.",
    "reviews.sample.2.location": "Haukilahti",
    "reviews.sample.3.text": "Clear pricing and appointments were kept. Highly recommend!",
    "reviews.sample.3.name": "Anna S.",
    "reviews.sample.3.location": "Saunalahti",
  },
};
