...
export const api = {
  ...
  updateCrewMember: (jobId: number, memberId: string, data: { name?: string; perWindowCents?: number; active?: boolean; role?: "worker" | "host"; rotateToken?: boolean; payAdjustmentCents?: number | null; payoutFixCents?: number | null; linkedUserId?: string; agreementSet?: "standard" | "kevyt"; endShift?: boolean; profile?: { fullName?: string; phone?: string; email?: string; city?: string; yTunnus?: string; iban?: string; answers?: Record<string, string> } }) =>
    request<{ ok: boolean; member: CrewMember; crew: CrewMember[] }>(
