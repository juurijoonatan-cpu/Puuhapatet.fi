...
const translations: Record<Language, Record<string, string>> = {
    ...
    "ba.before": "Ennen",
    "ba.after": "Jälkeen",
    "ba.alt": "Sama ikkunarivi ennen ja jälkeen pesun",
    "ba.handle": "Vertaile ennen ja jälkeen -kuvia",
    "ba.hint": "Vedä jakoviivaa tai valitse kahva ja käytä nuolinäppäimiä.",
    "ba.stat.label": "enemmän päivänvaloa sisään, kun lasi pestään molemmin puolin. Kirkas lasi kirkastaa samalla päiväsi.",
    "ba.stat.source": "Keskiarvo 430 ikkunan kenttätutkimuksessa (Sharples, Stewart & Tregenza, Building and Environment 2001). Puolet liasta istuu sisäpinnalla, joten koko hyöty tulee vasta täyspesusta.",
    "ba.point.1": "Sisä- ja ulkopinnat, karmit ja vesipellit samalla käynnillä",
    ...
    // Siivous — palvelu on avaamassa, ei vielä tilattavissa. Badge ja
    // "avaamme pian" ovat osa tekstiä, ei koriste: ilman niitä sivu lupaisi
    // palvelun jota ei ole.
    "services.soon": "Tulossa",
    "service.cleaning.title": "Siivous",
    "service.cleaning.desc": "Kotisiivous ja yritystilojen siivous ammattitaidolla — ylläpitosiivous sopimuksella, perusteellinen siivous ja muuttosiivous. Avaamme palvelun pian.",
    "service.cleaning.popup": "Sama tekemisen tapa kuin ikkunanpesussa: sovittu hinta etukäteen, siisti jälki ja työ tehdään loppuun. Hinta muodostuu työajasta — arvioimme neliöistä tunnit, joten tiedät mistä maksat. Palvelua ei voi vielä tilata, mutta laskurista saat ennakkoarvion ja voit ilmoittaa kiinnostuksen.",
    "service.cleaning.1": "Ylläpitosiivous viikoittain, kahden viikon välein tai kuukausittain",
    "service.cleaning.2": "Perusteellinen siivous ja muuttosiivous kertaluontoisesti",
    "service.cleaning.3": "Toimistot, liiketilat ja taloyhtiöiden yleiset tilat sopimuksella",
    "service.cleaning.4": "Ikkunanpesu samalle käynnille — se on jo meidän ydinosaamistamme",
    "service.cleaning.cta": "Laske ennakkoarvio",

    "faq.q11": "Milloin siivouspalvelu alkaa, ja voinko tilata sen nyt?",
    "faq.a11": "Siivous on työn alla emmekä ota siitä vielä tilauksia — avauspäivää ei ole lyöty lukkoon, joten emme lupaa sellaista. Laskurin Siivous-välilehdeltä saat ennakkoarvion ja voit jättää yhteystiedot, niin ilmoitamme heti kun palvelu on auki. Ikkunanpesun ja pihatyöt voit tilata normaalisti nyt.",
    ...
    "laskuri.tab.cleaning": "Siivous",

    // ─── SIIVOUS (tulossa) ───────────────────────────────────────────────────
    // Palvelua ei voi vielä tilata. Jokainen tämän ryhmän teksti on kirjoitettu
    // niin, että se kestää lukemisen sellaisenaan: arvio on arvio, ja
    // yhteydenotto on ilmoittautuminen eikä tilaus.
    "laskuri.clean.soon": "Tulossa",
    "laskuri.clean.title": "Siivous — koti ja yritys",
    "laskuri.clean.notice": "Avaamme siivouspalvelun pian, emmekä ota siitä vielä tilauksia. Voit laskea ennakkoarvion ja jättää yhteystiedot — ilmoitamme sinulle heti kun palvelu on auki, ja saat hinnan vahvistettuna ennen ensimmäistä käyntiä.",
    "laskuri.clean.seg": "Kohde",
    "laskuri.clean.seg.koti": "Koti",
    "laskuri.clean.seg.koti.sub": "Asunto tai omakotitalo",
    "laskuri.clean.seg.yritys": "Yritys tai taloyhtiö",
    "laskuri.clean.seg.yritys.sub": "Toimisto, liiketila, yleiset tilat",
    "laskuri.clean.noKv": "Yrityssiivous ei ole kotitalousvähennyskelpoista — se on yritykselle vähennyskelpoinen kulu. Hinnat sisältävät ALV:n.",
    "laskuri.clean.sqm": "Siivottava pinta-ala",
    "laskuri.clean.sqm.hint": "Valitse lähin tai näppäile neliöt. Tarkkaa lukua ei tarvita — arvio tarkentuu katselmuksessa.",
    "laskuri.clean.sqm.placeholder": "tai näppäile m²",
    "laskuri.clean.scope": "Työn laajuus",
    "laskuri.clean.scope.yllapito": "Ylläpitosiivous",
    "laskuri.clean.scope.yllapito.sub": "Säännöllinen siisteys: pinnat, imurointi, moppaus, wc ja keittiö",
    "laskuri.clean.scope.perus": "Perusteellinen siivous",
    "laskuri.clean.scope.perus.sub": "Kertaluontoinen suursiivous — myös ne kohdat joihin arjessa ei ehdi",
    "laskuri.clean.scope.muutto": "Muuttosiivous",
    "laskuri.clean.scope.muutto.sub": "Tyhjä koti luovutuskuntoon, kaapit ja kodinkoneet mukaan lukien",
    "laskuri.clean.freq": "Käyntitiheys",
    "laskuri.clean.freq.kerta": "Kertakäynti",
    "laskuri.clean.freq.kuukausi": "Kerran kuussa",
    "laskuri.clean.freq.kaksiviikko": "Kahden viikon välein",
    "laskuri.clean.freq.viikko": "Viikoittain",
    "laskuri.clean.perVisit": "/käynti",
    "laskuri.clean.perMonth": "Kuukaudessa",
    "laskuri.clean.addons": "Lisätyöt käynnille",
    "laskuri.clean.addon.ikkunat": "Ikkunanpesu samalla käynnillä",
    "laskuri.clean.addon.uuni": "Uunin pesu",
    "laskuri.clean.addon.jaakaappi": "Jääkaappi sisältä",
    "laskuri.clean.addon.parveke": "Parvekkeen pesu",
    "laskuri.clean.model": "Mistä hinta muodostuu",
    "laskuri.clean.model.desc": "Siivouksen hinta on työaikaa: arvioimme noin {sqmh} m² työtunnissa ja veloitamme {eurh} €/h, välineet ja aineet mukaan lukien. Lyhin käynti on {min} h.",
    "laskuri.clean.hours": "h",
    "laskuri.clean.min": "Kohde on pieni, joten arvio on lyhimmän käynnin ({min} h) mukainen. Käytämme kaiken ajan hyödyksi.",
    "laskuri.clean.app": "Tilaukset ja aikataulut sovelluksessa",
    "laskuri.clean.app.desc": "Asiakkaamme hoitavat jo tarjouksen hyväksynnän, aikatoiveet ja työn seurannan omasta linkistään selaimessa — ilman sovelluskaupan latauksia. Siivouksen käyntipyynnöt ja toistuva aikataulu tulevat samaan näkymään palvelun avautuessa.",
    "laskuri.clean.disclaimer": "Ennakkoarvio, ei tilaus eikä tarjous. Lopullinen hinta sovitaan aina katselmuksen jälkeen ennen ensimmäistä käyntiä.",
    "laskuri.clean.cta": "Ilmoita kiinnostus",
    "laskuri.clean.form.title": "Yhteystiedot — ilmoittautuminen",
    "laskuri.clean.form.desc": "Emme aloita siivousta tästä. Otamme yhteyttä kun palvelu avautuu ja käymme hinnan läpi ennen kuin mitään sovitaan.",
    "laskuri.clean.sent.desc": "Kiitos! Olet listalla. Otamme yhteyttä heti kun siivouspalvelu on auki — silloin käydään kohde ja hinta läpi ennen ensimmäistä käyntiä.",
  ...
  en: {
    ...
    "ba.before": "Before",
    "ba.after": "After",
    "ba.alt": "The same row of windows before and after cleaning",
    "ba.handle": "Compare the before and after photos",
    "ba.hint": "Drag the divider, or focus the handle and use the arrow keys.",
    "ba.stat.label": "more daylight through the glass once both sides are washed. Clear glass brightens your day along with it.",
    "ba.stat.source": "Average across a field survey of 430 windows (Sharples, Stewart & Tregenza, Building and Environment 2001). Half the dirt sits on the inside, so the full gain needs a wash on both sides.",
    "ba.point.1": "Inside and out, frames and sills on the same visit",
    ...
    "services.soon": "Coming",
    "service.cleaning.title": "Cleaning",
    "service.cleaning.desc": "Professional home and business cleaning — maintenance cleaning on a contract, deep cleans and move-out cleaning. We're opening this service soon.",
    "service.cleaning.popup": "The same way of working as our window cleaning: the price agreed in advance, a tidy finish, and the job finished properly. The price comes from working time — we estimate hours from the area, so you can see what you're paying for. You can't order it yet, but the calculator gives you an advance estimate and lets you register interest.",
    "service.cleaning.1": "Maintenance cleaning weekly, every two weeks or monthly",
    "service.cleaning.2": "Deep cleans and move-out cleaning as one-off jobs",
    "service.cleaning.3": "Offices, retail spaces and housing-company common areas by agreement",
    "service.cleaning.4": "Window cleaning on the same visit — that part is already our core skill",
    "service.cleaning.cta": "Calculate an estimate",

    "faq.q11": "When does the cleaning service start, and can I order it now?",
    "faq.a11": "Cleaning is in the works and we're not taking orders for it yet — the opening date isn't fixed, so we won't promise one. The Cleaning tab in the calculator gives you an advance estimate and lets you leave your details, and we'll let you know the moment we open. Window cleaning and garden work can be ordered as normal right now.",
    ...
    "laskuri.tab.cleaning": "Cleaning",

    "laskuri.clean.soon": "Coming",
    "laskuri.clean.title": "Cleaning — homes and businesses",
    "laskuri.clean.notice": "We're opening our cleaning service soon and are not taking cleaning orders yet. You can calculate an advance estimate and leave your details — we'll let you know the moment we open, and you'll get a confirmed price before the first visit.",
    "laskuri.clean.seg": "Property",
    "laskuri.clean.seg.koti": "Home",
    "laskuri.clean.seg.koti.sub": "Apartment or house",
    "laskuri.clean.seg.yritys": "Business or housing company",
    "laskuri.clean.seg.yritys.sub": "Office, retail space, common areas",
    "laskuri.clean.noKv": "Business cleaning does not qualify for the household tax credit — it is a deductible business expense instead. Prices include VAT.",
    "laskuri.clean.sqm": "Area to be cleaned",
    "laskuri.clean.sqm.hint": "Pick the closest option or type the square metres. An exact number isn't needed — the estimate is refined at the site visit.",
    "laskuri.clean.sqm.placeholder": "or type m²",
    "laskuri.clean.scope": "Scope of work",
    "laskuri.clean.scope.yllapito": "Maintenance cleaning",
    "laskuri.clean.scope.yllapito.sub": "Regular upkeep: surfaces, vacuuming, mopping, bathroom and kitchen",
    "laskuri.clean.scope.perus": "Deep clean",
    "laskuri.clean.scope.perus.sub": "A one-off thorough clean — including the spots everyday life skips",
    "laskuri.clean.scope.muutto": "Move-out cleaning",
    "laskuri.clean.scope.muutto.sub": "An empty home brought to handover condition, cupboards and appliances included",
    "laskuri.clean.freq": "Frequency",
    "laskuri.clean.freq.kerta": "One-off visit",
    "laskuri.clean.freq.kuukausi": "Monthly",
    "laskuri.clean.freq.kaksiviikko": "Every two weeks",
    "laskuri.clean.freq.viikko": "Weekly",
    "laskuri.clean.perVisit": "/visit",
    "laskuri.clean.perMonth": "Per month",
    "laskuri.clean.addons": "Add-ons per visit",
    "laskuri.clean.addon.ikkunat": "Window cleaning on the same visit",
    "laskuri.clean.addon.uuni": "Oven cleaning",
    "laskuri.clean.addon.jaakaappi": "Fridge interior",
    "laskuri.clean.addon.parveke": "Balcony wash",
    "laskuri.clean.model": "How the price is formed",
    "laskuri.clean.model.desc": "Cleaning is priced as time: we estimate about {sqmh} m² per work hour and charge {eurh} €/h, equipment and supplies included. The shortest visit is {min} h.",
    "laskuri.clean.hours": "h",
    "laskuri.clean.min": "The property is small, so the estimate uses our shortest visit ({min} h). We put the whole time to good use.",
    "laskuri.clean.app": "Requests and schedules in the app",
    "laskuri.clean.app.desc": "Our customers already approve quotes, suggest times and follow the work from their own link in the browser — no app store download. Cleaning visit requests and recurring schedules join the same view when the service opens.",
    "laskuri.clean.disclaimer": "An advance estimate, not an order or a quote. The final price is always agreed after a site visit, before the first cleaning.",
    "laskuri.clean.cta": "Register interest",
    "laskuri.clean.form.title": "Contact details — registration",
    "laskuri.clean.form.desc": "This does not start a cleaning. We'll contact you when the service opens and go through the price before anything is agreed.",
    "laskuri.clean.sent.desc": "Thank you — you're on the list. We'll be in touch as soon as the cleaning service opens, and we'll go through the property and the price before the first visit.",
